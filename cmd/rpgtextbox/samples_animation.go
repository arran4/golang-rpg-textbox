...
var _ Cmd = (*SamplesAnimation)(nil)

type SamplesAnimation struct {
	*Samples
	Flags         *flag.FlagSet
	width         int
	height        int
	...
	CommandAction func(c *SamplesAnimation) error
}

type UsageDataSamplesAnimation struct {
	*SamplesAnimation
	Recursive bool
}

func (c *SamplesAnimation) Usage() {
	err := executeUsage(os.Stderr, "animation_usage.txt", UsageDataSamplesAnimation{c, false})
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error generating usage: %s\n", err)
	}
}

func (c *SamplesAnimation) UsageRecursive() {
	err := executeUsage(os.Stderr, "animation_usage.txt", UsageDataSamplesAnimation{c, true})
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error generating usage: %s\n", err)
	}
}

func (c *SamplesAnimation) Execute(args []string) error {
...
func (c *Samples) NewSamplesAnimation() *SamplesAnimation {
	...
	v.CommandAction = func(c *SamplesAnimation) error {

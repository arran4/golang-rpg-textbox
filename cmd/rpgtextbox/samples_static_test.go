...
func TestSamplesStatic_Execute(t *testing.T) {
	...
	cmd := parent.NewSamplesStatic()

	called := false
	cmd.CommandAction = func(c *SamplesStatic) error {
		called = true
		return nil
	}
...
func TestSamplesStatic_ExecuteHelpAndUnknownFlags(t *testing.T) {
